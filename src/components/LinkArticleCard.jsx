...
export default function LinkArticleCardComponent() {
  return (
    <div class="max-w-sm w-full lg:max-w-full lg:flex shadow-lg">
      ...
      <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
        <div class="mb-8">
          ...
          <div class="text-gray-900 font-bold text-xl mb-2"><Link to="/links/1">Can coffee make you a better developer?</Link></div>
